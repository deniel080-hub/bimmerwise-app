...
class GearboxBookingPage extends StatefulWidget {
  final String userId;

  const GearboxBookingPage({
    super.key,
    required this.userId,
  });

  @override
  State<GearboxBookingPage> createState() => _GearboxBookingPageState();
}

class _GearboxBookingPageState extends State<GearboxBookingPage> {
  ...
  final Map<String, double> _enginePrices = {
    'Petrol/Diesel': 625.0,
    'Plug In Hybrid': 700.0,
  };
    ...
    try {
      ...
      setState(() {
        ...
        if (_vehicles.isNotEmpty) {
          ...
          // Auto-select engine type based on vehicle fuel type
          final firstVehicleFuelType = _vehicles.first['fuelType'] as String?;
          if (firstVehicleFuelType != null) {
            if (firstVehicleFuelType == 'Petrol Plugin Hybrid') {
              _selectedEngineType = 'Plug In Hybrid';
            } else if (firstVehicleFuelType == 'Petrol' || firstVehicleFuelType == 'Diesel') {
              _selectedEngineType = 'Petrol/Diesel';
            }
          }
        }
        _isLoading = false;
  ...
  bool _validateForm() {
    ...
    if (_selectedEngineType == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('Please select an engine type'),
          backgroundColor: Theme.of(context).colorScheme.error,
        ),
      );
      return false;
  ...
  Future<void> _submitBooking() async {
    ...
    try {
      ...
      final price = _enginePrices[_selectedEngineType]!;
      
      final description = 'Gearbox Service Using GENUINE ZF TRANSMISSION OIL PAN Filter Gasket - $_selectedEngineType\n'
          'VIN: ${_vinController.text.trim()}\n'
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'Using GENUINE ZF TRANSMISSION OIL PAN Filter Gasket',
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          // Auto-update engine type when vehicle is selected
                                          final fuelType = vehicle['fuelType'] as String?;
                                          if (fuelType != null) {
                                            if (fuelType == 'Petrol Plugin Hybrid') {
                                              _selectedEngineType = 'Plug In Hybrid';
                              ...
                              const SizedBox(height: AppSpacing.md),
                              ..._enginePrices.entries.map((entry) {
                                final isSelected = _selectedEngineType == entry.key;
                                return Padding(
                                  padding: const EdgeInsets.only(bottom: AppSpacing.md),
                                  child: GestureDetector(
                                    onTap: () => setState(() => _selectedEngineType = entry.key),
                                    child: Container(
                                      padding: AppSpacing.paddingMd,
                                      decoration: BoxDecoration(
                                        color: isSelected
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '€${_enginePrices[_selectedEngineType]!.toStringAsFixed(0)}',
